...
function draw() {
    ...
    currImg.resize(currImg.width/4,currImg.height/4);//scaled down images processed
    currImg.filter(BLUR,3); //apply blur filter for three times to reduce noise

    diffImg = createImage(video.width, video.height);
    diffImg.resize(diffImg.width/4,diffImg.height/4);//scaled down images processed
    diffImg.loadPixels();
...
//adapted from function keypress below
